...
// src/services/default-custom-prompts.ts
var SIDEBAR_DEFAULT_CATEGORIES = /* @__PURE__ */ new Set([
  "basic",
  "xiaohongshu",
  "video",
  "wechat",
...
function getDefaultSidebarPrompts() {
  const presetPrompts = getAllPresets().filter((prompt) => SIDEBAR_DEFAULT_CATEGORIES.has(prompt.category || "")).map((prompt, index) => ({
    ...prompt,
