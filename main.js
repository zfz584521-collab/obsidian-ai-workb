...
var PublishEditorModal = class extends import_obsidian12.Modal {
  ...
  renderBaseEditor(container) {
    new import_obsidian12.Setting(container).setName("\u6807\u9898").addText((text) => text.setValue(this.state.base.title).onChange((value) => this.state.base.title = value));
    new import_obsidian12.Setting(container).setName("\u6B63\u6587").addTextArea((text) => text.setValue(this.state.base.bodyMarkdown).onChange((value) => this.state.base.bodyMarkdown = value));
    new import_obsidian12.Setting(container).setName("\u6458\u8981").addTextArea((text) => text.setValue(this.state.base.summary || "").onChange((value) => this.state.base.summary = value));
    new import_obsidian12.Setting(container).setName("\u6807\u7B7E").setDesc("\u4F7F\u7528\u9017\u53F7\u5206\u9694").addText((text) => text.setValue(this.state.base.tags.join(", ")).onChange((value) => this.state.base.tags = parseTags(value)));
  }
  ...
  renderOverrideField(container, field, label, textarea) {
    ...
    const setting = new import_obsidian12.Setting(container).setName(label).setDesc(enabled ? "\u5DF2\u8986\u76D6" : "\u7EE7\u627F\u7EDF\u4E00\u5185\u5BB9").addToggle((toggle) => toggle.setValue(enabled).onChange((value) => {
      if (value) {
  ...
  renderOverrideTags(container) {
    ...
    const resolved = this.state.resolve(platform);
    new import_obsidian12.Setting(container).setName("\u5E73\u53F0\u6807\u7B7E").setDesc(enabled ? "\u5DF2\u8986\u76D6" : "\u7EE7\u627F\u7EDF\u4E00\u5185\u5BB9").addToggle((toggle) => toggle.setValue(enabled).onChange((value) => {
      if (value) {
  ...
  renderMediaOverride(container) {
    ...
    new import_obsidian12.Setting(container).setName("\u5E73\u53F0\u5A92\u4F53").setDesc(overridden ? "\u5DF2\u8986\u76D6" : "\u7EE7\u627F\u7EDF\u4E00\u5185\u5BB9").addToggle((toggle) => toggle.setValue(overridden).onChange((value) => {
      var _a, _b;
      if (value) {
        const resolved = this.state.resolve(platform);
  ...
  async submit() {
    ...
    try {
      ...
      new import_obsidian12.Notice("\u5A92\u4F53\u8F7D\u5165\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u6587\u4EF6\u662F\u5426\u4ECD\u7136\u5B58\u5728");
    } finally {
      this.submitting = false;
      this.render();
    }
...
var VaultMediaPicker = class extends import_obsidian12.FuzzySuggestModal {
...
var AIWorkbenchPlugin = class extends import_obsidian13.Plugin {
  constructor() {
    super(...arguments);
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      callback: () => {
        ...
        if (platforms.length === 0) {
          new import_obsidian13.Notice("\u8BF7\u5148\u5728\u8BBE\u7F6E\u4E2D\u542F\u7528\u5E76\u914D\u7F6E\u81F3\u5C11\u4E00\u4E2A\u53D1\u5E03\u5E73\u53F0");
          return;
        }
  ...
  async openPublishingModal(platforms) {
    ...
    if (!file || file.extension !== "md") {
      new import_obsidian13.Notice("\u8BF7\u5148\u6253\u5F00\u4E00\u7BC7 Markdown \u7B14\u8BB0");
      return;
    }
    ...
    if (available.length === 0) {
      new import_obsidian13.Notice("\u6240\u9009\u5E73\u53F0\u5C1A\u672A\u542F\u7528\u6216\u914D\u7F6E\u5B8C\u6210");
      return;
    }
  ...
  showStatisticsModal() {
    ...
    new StatisticsModal(
      ...
      async () => {
        ...
        new import_obsidian13.Notice("\u7EDF\u8BA1\u5DF2\u91CD\u7F6E");
      }
    ).open();
  }
  /**
  ...
  async executeAction(actionType, isSelection = false) {
    if (this.isProcessing) {
      new import_obsidian13.Notice("\u6B63\u5728\u5904\u7406\u4E2D\uFF0C\u8BF7\u7A0D\u5019...");
      return;
    }
    this.isProcessing = true;
    try {
      const file = this.app.workspace.getActiveFile();
      if (!file) {
        new import_obsidian13.Notice("\u6CA1\u6709\u6253\u5F00\u7684\u7B14\u8BB0");
        return;
      }
      if (!(file instanceof import_obsidian13.TFile)) {
        new import_obsidian13.Notice("\u5F53\u524D\u6587\u4EF6\u4E0D\u662F\u7B14\u8BB0");
        return;
      }
      const content = await this.app.vault.read(file);
      const selectedText = this.getSelectedText();
      if (isSelection && !selectedText) {
        new import_obsidian13.Notice("\u8BF7\u5148\u9009\u4E2D\u8981\u5904\u7406\u7684\u6587\u5B57");
        return;
      }
      const context = {
        notePath: file.path,
      ...
      new import_obsidian13.Notice(`\u6B63\u5728\u5904\u7406: ${actionName}...`);
      ...
      if (result.success && result.output) {
          ...
          this.previewService.showPreview(
            ...
            async () => {
              ...
              if (applyResult.success) {
                new import_obsidian13.Notice(`${actionName} \u5B8C\u6210`);
            ...
            () => {
              new import_obsidian13.Notice("\u5DF2\u53D6\u6D88\u64CD\u4F5C");
            }
          );
        } else {
          const applyResult = await this.actionHandler.applyResult(actionType, context, result.output);
        ...
        new import_obsidian13.Notice(`\u64CD\u4F5C\u5931\u8D25: ${result.error}`);
  ...
  async executeCustomPrompt(promptId) {
    ...
    try {
      ...
      if (!prompt) {
        new import_obsidian13.Notice("Prompt \u4E0D\u5B58\u5728");
        return;
      }
      const file = this.app.workspace.getActiveFile();
      if (!file) {
      ...
      new import_obsidian13.Notice(`\u6B63\u5728\u6267\u884C: ${prompt.name}...`);
      const result = await this.actionHandler.execute("custom", context, prompt);
      if (result.success) {
        this.statusBarService.setCompleted(result.tokensUsed);
        new import_obsidian13.Notice(`${prompt.name} \u5B8C\u6210`);
  ...
  showPresetImportModal() {
    new PresetImportModal(
      ...
      async (selectedPresets) => {
        ...
        this.refreshCustomPromptCommands();
        new import_obsidian13.Notice(`\u5DF2\u5BFC\u5165 ${imported} \u4E2A\u9884\u8BBE Prompt`);
      }
    ).open();
  }
  /**
...
var WorkbenchView = class extends import_obsidian13.ItemView {
  ...
  renderPublishingControls() {
    ...
    (0, import_obsidian13.setIcon)(settingsButton, "settings");
    ...
    for (const platform of PUBLISHING_PLATFORMS) {
      ...
      (0, import_obsidian13.setIcon)(icon, selected ? "check" : "circle");
      button.createSpan({ text: labels[platform] });
      button.addEventListener("click", () => {
        if (!configured) {
          new import_obsidian13.Notice(`${labels[platform]}\u5C1A\u672A\u914D\u7F6E\uFF0C\u8BF7\u5148\u524D\u5F80\u8BBE\u7F6E`);
    ...
    (0, import_obsidian13.setIcon)(publishIcon, "send");
...
var InstructionModal = class extends import_obsidian13.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian13.Setting(contentEl).setName("\u9644\u52A0\u6307\u4EE4").setDesc("\u8F93\u5165\u4F60\u60F3\u8BA9 Claudian \u6267\u884C\u7684\u64CD\u4F5C").addText((text) => text.setPlaceholder("\u4F8B\u5982\uFF1A\u5E2E\u6211\u91CD\u5199\u8FD9\u4E00\u6BB5...").onChange((value) => {
      this.instruction = value;
    }));
    new import_obsidian13.Setting(contentEl).addButton((btn) => btn.setButtonText("\u53D6\u6D88").onClick(() => {
      this.close();
...
var PresetImportModal = class extends import_obsidian13.Modal {
  ...
  onOpen() {
    ...
    this.renderCategories(container);
    const footerSetting = new import_obsidian13.Setting(contentEl);
...
var StatisticsModal = class extends import_obsidian13.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian13.Setting(contentEl).addButton((btn) => btn.setButtonText("\u91CD\u7F6E\u7EDF\u8BA1").setWarning().onClick(async () => {
      this.onReset();
      this.close();
